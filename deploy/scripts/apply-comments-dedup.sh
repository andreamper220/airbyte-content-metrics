...
docker exec content-metrics-clickhouse-1 clickhouse-client -q "SELECT video_id, author, substring(text,1,50), likes FROM analytics.raw_video_comments ORDER BY video_id, likes DESC"
echo "==== health ===="
